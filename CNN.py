# -*- coding: utf-8 -*-
"""
Created on Sat Nov 22 14:22:14 2025
...
# CNN
classifier.compile(optimizier = "adam", loss = "binary_crossentropy", metrics = ["accuracy"])
...
sonuc["tahminler"] = predsonuc["test"] = test_labels
